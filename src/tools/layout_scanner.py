...
class ChartRegion(BaseModel):
    ...
    # --- METADATA ---
    title: str = Field(default="", description="The explicit chart title (e.g., 'Adjusted EBITDA').")
    footnotes: List[str] = Field(default_factory=list, description="Source notes or citations found near the chart.")
    ...
    # CONTENT EXTRACTION (Directly from Scout)
